...
// ============================================
const int DEVICE_NUMBER = 3;  // ← CHANGE THIS TO YOUR ASSIGNED NUMBER!
// ============================================
...
// ADC and thresholds
const int ADC_MAX = 1023;               // Set to 4095 for 12-bit boards (e.g., Nano 33 BLE)
...
void handleInput() 
{
  ...
  // or you can prioritize one direction if desired.
  ...
  // Debug prints to help tune thresholds (comment out for production)
  Serial.print("UP(A5): ");
